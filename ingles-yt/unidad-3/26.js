...
to  auxiliar/para   persona|lugar|verbo infinitivo

for para/por        persona|verbo ing
-----------------------------------
grammatically correct
grammarly correct

para expresar verbos infinitivos, es obligatorio el (to),
si es que preguntan en un examen.

expresa bailar, comer, caminar

to dance, to eat, to walk.

don't = dance, eat, walk
-----------------------------------
pero para verbos gerundios (end with ing) no es necesario el (for)

exprese bailando, comiendo, caminando.

dancing, eating, walking
